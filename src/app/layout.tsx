...
export const metadata: Metadata = {
  title: "Grand Haven Hotel - Luxury Accommodations & Premium Hospitality",
  description: "Experience unparalleled luxury at Grand Haven Hotel with world-class amenities, fine dining, spa services, and exceptional hospitality in the heart of the city.",
  keywords: "luxury hotel, premium accommodations, business travel, spa services, fine dining, concierge, city hotel",
  metadataBase: new URL("https://grandhaven-hotel.com"),
  alternates: {
    canonical: "https://grandhaven-hotel.com"
  },
  openGraph: {
    title: "Grand Haven Hotel - Luxury Accommodations & Premium Hospitality",
    description: "Experience unparalleled luxury at Grand Haven Hotel with world-class amenities, fine dining, spa services, and exceptional hospitality.",
    siteName: "Grand Haven Hotel",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T5izMxldBWO3pvAnJwuKTzxAr/uploaded-1763414301431-4ad0338z.jpg",
  ...
  twitter: {
    ...
    title: "Grand Haven Hotel - Luxury Accommodations & Premium Hospitality",
    description: "Experience unparalleled luxury at Grand Haven Hotel with world-class amenities, fine dining, spa services, and exceptional hospitality.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T5izMxldBWO3pvAnJwuKTzxAr/uploaded-1763414301431-4ad0338z.jpg"]
  },
  robots: {
    index: true,
    follow: true
